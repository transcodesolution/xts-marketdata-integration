...
var d = new Date();
var todaysDateWithTime = d.getDayFormatted() + '' + d.getMonthFormatted() + '' + d.getFullYear()+" T "+d.getHourFormatted()+"_"+d.getMinuteFormatted();
var logFileName =dir + "/debug_" + todaysDateWithTime + ".txt";
var initMessage = "============================================\nInitialized logger\n==================================================\n";
//var dir = '../logs';
